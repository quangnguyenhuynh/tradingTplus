...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--date", default=None, help="DD/MM/YYYY. Default: yesterday (UTC+7 in daily_run)")
...
def main() -> None:
    ...
    if date:
        try:
            ...
            raise SystemExit("❌ --date phải đúng format DD/MM/YYYY")

    print("📌 E2E DEMO CONFIG")
    print(f"   date       : {date or 'default(yesterday UTC+7)'}")
