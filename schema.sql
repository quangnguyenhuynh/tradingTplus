...
comment on table public.stock_foreign_features_daily is 'Derived Foreign EOD Feature V2 from rolling same-symbol stock_daily rows; money in VND, ratios stored as fractions.';
...
comment on column public.stock_foreign_features_daily.source_fingerprint is 'SHA-256 identity of formula V2, symbol, target date, and the at-most-20 same-symbol source rows affecting metrics/quality.';
