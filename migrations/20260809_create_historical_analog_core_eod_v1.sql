...
create table if not exists public.analog_snapshots (
  ...
  check (evaluation_status <> 'evaluable' or (jsonb_object_length(dimensions)=9 and dimensions ?& array['return_5d','price_vs_ema20_pct','ema20_vs_ema50_pct','rsi14','macd_histogram_pct','distance_to_high20_pct','volume_ratio','value_ratio','close_position_in_candle']))
);
